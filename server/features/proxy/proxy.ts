...
export default class ConsensusProxy {
  ...
  async handleRequest(
    ...
    // resolveAndCheckTarget throws for private/invalid targets AND returns the
    // verified IP so makeRequest can pin the connection to it, closing the TOCTOU
    // gap between the SSRF check and the actual TCP connect.
